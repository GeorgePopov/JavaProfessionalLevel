...
public class Box<T extends Fruit> {
    ...
    public Box(T... arr) {
        list = new ArrayList<T>(Arrays.asList(arr)); // так можно заполнять при создании кол-цию, через кон-тор и массив
    }
    ...
    public void transfer(Box<? super T> another) { // <? super T> - ???
